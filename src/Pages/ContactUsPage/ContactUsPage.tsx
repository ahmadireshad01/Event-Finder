...
export default function ContactUsPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {console.log('Form submitted');}
        ...
        <Nav/>
            <div className=" text-white min-h-screen flex items-center justify-center px-4">
                <div className="w-full max-w-xl space-y-8 text-center">
                    ...
                    Alternatively, you can reach us directly at <a href="mailto:support@localevents.com" className="underline">support@localevents.com</a>
                    </p>
                </div>
            </div>
    </>
