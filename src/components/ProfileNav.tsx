  ...
  return (
    <nav className="flex justify-between p-4 border-b fixed top-0 right-0 left-0 z-20  bg-slate-900 hover:shadow-lg shadow-slate-600 ease-in-out transition duration-300">
      <div className="flex items-center gap-4 pl-5">
        ...
        <div className="flex font-light gap-6 max-md:hidden">
          ...
          <a
            ...
            className="font-light cursor-pointer text-white"
          >
            Create
          </a>
        </div>
      ...
      <div className="flex items-center gap-6">
        <button className="max-md:hidden bg-gray-700 h-9 rounded-lg w-9 p-3 hover:opacity-70 transition ease-in-out">
          <img src="./public/images/navimg/notificationIcon.svg" alt="" />
        </button>
        <img
      ...
      {isMenuOpen && (
        <div className="flex flex-col gap-7 absolute top-18 right-3 bg-slate-900 p-5 rounded-lg shadow-lg z-20">
          <img
            ...
            alt=""
          />
          <a className="font-light cursor-pointer text-white">Home</a>
          <a className="font-light cursor-pointer">Explore</a>
          <a className="font-light  cursor-pointer">Create</a>
          <button className=" bg-gray-700 h-9 rounded-lg w-9 p-3 hover:opacity-70 transition ease-in-out">
            <img src="./public/images/navimg/notificationIcon.svg" alt="" />
          </button>
        </div>
      )}
